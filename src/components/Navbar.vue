    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul>
          ...
          <li><a target="_blank" href="https://basednames.xyz">.based (The Based DAO, Base)</a></li>
          <li><a target="_blank" href="https://id.basepunk.xyz">.basepunk (BasePunk NFT, Base)</a></li>
